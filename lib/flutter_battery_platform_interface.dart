...
abstract class FlutterBatteryPlatform extends PlatformInterface {
  ...
  Future<List<String>> getBatteryOptimizationTips() {
    throw UnimplementedError(
        'getBatteryOptimizationTips() has not been implemented.');
  }
  ...
  void setLowBatteryCallback(Function(int batteryLevel) callback) {
    throw UnimplementedError(
        'setLowBatteryCallback() has not been implemented.');
  }

  /// 设置电池电量变化回调函数
  void setBatteryLevelChangeCallback(Function(int batteryLevel) callback) {
    throw UnimplementedError(
        'setBatteryLevelChangeCallback() has not been implemented.');
  }
  ...
  void setBatteryInfoChangeCallback(
    ...
    throw UnimplementedError(
        'setBatteryInfoChangeCallback() has not been implemented.');
  }
  ...
  void setBatteryHealthChangeCallback(
    ...
    throw UnimplementedError(
        'setBatteryHealthChangeCallback() has not been implemented.');
  }
  ...
  Future<Map<String, bool>> configureBatteryMonitor({
    ...
    if (monitorBatteryLevel) {
      result['batteryLevelMonitor'] =
          await startBatteryLevelListening() ?? false;
    } else {
      result['batteryLevelMonitor'] =
          await stopBatteryLevelListening() ?? false;
    }
    ...
    if (monitorBatteryHealth) {
      ...
      result['batteryHealthMonitor'] =
          await stopBatteryHealthListening() ?? false;
    }
  ...
  Future<bool?> startBatteryLevelListening() {
    throw UnimplementedError(
        'startBatteryLevelListening() has not been implemented.');
  }

  /// 停止监听电池电量变化
  Future<bool?> stopBatteryLevelListening() {
    throw UnimplementedError(
        'stopBatteryLevelListening() has not been implemented.');
  }
  ...
  Future<bool?> startBatteryInfoListening({
    ...
    throw UnimplementedError(
        'startBatteryInfoListening() has not been implemented.');
  }

  /// 停止监听完整电池信息变化
  Future<bool?> stopBatteryInfoListening() {
    throw UnimplementedError(
        'stopBatteryInfoListening() has not been implemented.');
  }
  ...
  Future<bool?> startBatteryHealthListening({
    ...
    throw UnimplementedError(
        'startBatteryHealthListening() has not been implemented.');
  }

  /// 停止监听电池健康状态
  Future<bool?> stopBatteryHealthListening() {
    throw UnimplementedError(
        'stopBatteryHealthListening() has not been implemented.');
  }
  ...
  Future<bool?> setBatteryLevelThreshold({
    ...
    throw UnimplementedError(
        'setBatteryLevelThreshold() has not been implemented.');
  }

  /// 停止电池电量监控
  Future<bool?> stopBatteryMonitoring() {
    throw UnimplementedError(
        'stopBatteryMonitoring() has not been implemented.');
  }
